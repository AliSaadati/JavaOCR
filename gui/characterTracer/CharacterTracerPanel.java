...
public class CharacterTracerPanel extends JPanel
{
    ...
    // Add description, control panel, and extract button.
    ...
    // Create a description under the menu bar and tab pane for the Character Tracer.
    ...
    // Add getImageSelectPanel() to Jpanel.
