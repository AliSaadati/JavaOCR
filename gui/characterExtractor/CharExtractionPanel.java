...
public class CharExtractionPanel extends JPanel
{
    ...
    // Creates a description text label below the menu bar and tab pane.
    ...
    // Call input and output directory and pixel size methods; add them to
    // new JPanel in menu.
    ...
    // Create button to determine if file is ready to be extracted. Displays
    // message if both files are not ready or pixel size invalid.
    ...
    // Create Panel to contain image input directory label, textbox, and button.
    ...
    // Create Panel to contain output directory label, textbox, and button.
    ...
    // ActionListener for input image.
    ...
    // ActionListener for output directory.
