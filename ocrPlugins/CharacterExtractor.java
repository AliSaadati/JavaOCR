...
public class CharacterExtractor extends DocumentScannerListenerAdaptor
{
    ...
    public void slice(File inputImage, File outputDir, int std_width, int std_height)
    {
        try
        {
            /// Set width, height, input and output directories for image. Process image
            /// through a PixelImage object. Set pixelImage to b&w and filter the image.
            //
    ...
    //***** Creates file with Extracted Character's Image.
